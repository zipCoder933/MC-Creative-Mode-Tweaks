...
public class Config {
    ...
    public static ModConfigSpec.IntValue REACH_MAX_RANGE =
    ...
    //Client
    public static ModConfigSpec.IntValue REPLACE_INTERVAL =
            COMMON_BUILDER.comment("The interval in ticks to run replace tool")
                    .defineInRange("client.REPLACE_INTERVAL", 1, 1, 256);

    public static ModConfigSpec.BooleanValue INVERT_REPLACE_LOCK =
